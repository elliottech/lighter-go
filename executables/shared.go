...
var (
	...
	allTxClients    map[int64]map[uint8]*client.TxClient // accountIndex -> apiKeyIndex -> client

	// Legacy support for old API - kept for compatibility
	txClient        *client.TxClient // Deprecated: Use GetClientForAPIKey instead
	backupTxClients map[uint8]*client.TxClient // Deprecated: Use allTxClients instead
)
...
func GetClientForAPIKey(apiKeyIndex uint8, accountIndex int64) (*client.TxClient, error) {
	txClientMu.Lock()
...
func getDefaultClient() (*client.TxClient, error) {
...
func CreateClient(url, privateKey string, chainId uint32, apiKeyIndex uint8, accountIndex int64) error {
	...
	txClientInstance, err := client.NewTxClient(httpClient, privateKey, accountIndex, apiKeyIndex, chainId)
	if err != nil {
	...
	// Update default client (first created becomes default)
	if defaultTxClient == nil {
...
func GetClient() *client.TxClient {
	return txClient
}

// GetBackupClients returns the backup clients map
func GetBackupClients() map[uint8]*client.TxClient {
