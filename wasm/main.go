...
func main() {
	...
	js.Global().Set("CreateAuthToken", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		token, err := client.CreateAuthToken(deadline, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
	...
	js.Global().Set("SignCreateOrder", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetCreateOrderTransaction(
	...
	js.Global().Set("SignCancelOrder", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetCancelOrderTransaction(marketIndex, orderIndex, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignCancelAllOrders", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetCancelAllOrdersTransaction(timeInForce, timeVal, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignTransfer", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetTransferTransaction(toAccount, usdcAmount, fee, nonce, memoArr, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignWithdraw", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetWithdrawTransaction(usdcAmount, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignUpdateLeverage", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetUpdateLeverageTransaction(marketIndex, marginMode, fraction, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignModifyOrder", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetModifyOrderTransaction(marketIndex, index, baseAmount, price, triggerPrice, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignCreateSubAccount", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetCreateSubAccountTransaction(nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignCreatePublicPool", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetCreatePublicPoolTransaction(operatorFee, initialTotalShares, minOperatorShareRate, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignUpdatePublicPool", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetUpdatePublicPoolTransaction(publicPoolIndex, status, operatorFee, minOperatorShareRate, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignMintShares", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetMintSharesTransaction(publicPoolIndex, shareAmount, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignBurnShares", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetBurnSharesTransaction(publicPoolIndex, shareAmount, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
	...
	js.Global().Set("SignUpdateMargin", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		txInfo, err := client.GetUpdateMarginTransaction(marketIndex, direction, usdcAmount, nonce, apiKeyIndex, accountIndex)
		if err != nil {
			return js.ValueOf(map[string]interface{}{"error": wrapErr(err)})
		}
		return js.ValueOf(map[string]interface{}{"txInfo": txInfo, "error": ""})
